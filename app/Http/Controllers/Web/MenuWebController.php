...
class MenuWebController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Menu::create($request->only(['nama_menu','harga','stok','id_kategori','status_menu']));
    ...
    public function update(Request $request, Menu $menu)
    {
        ...
        $menu->update($request->only(['nama_menu','harga','stok','id_kategori','status_menu']));
    ...
    public function destroy(Menu $menu)
    {
        if ($menu->detailTransaksi()->exists()) {
            ...
            return redirect()->route('menu.index')->with('success', 'Menu dinonaktifkan karena pernah ada di transaksi.');
        }
        $menu->delete();
